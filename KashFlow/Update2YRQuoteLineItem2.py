...
# Second CY
year2 = input_data['YE2']
Description2 = "Associate Fee for R&D Tax relief claim: \n- Rate "+input_data['COP2']+" \n- "+year2+": Fee "+input_data['CF2']

if 'COF2' in input_data:
    if input_data['COF2'] is None:
        Rate2 = 0.0
    else:
        Rate2 = float(input_data['COF2'])
else:
    Rate2 = 0.0
       
VATAmount2 = Rate2*0.2
